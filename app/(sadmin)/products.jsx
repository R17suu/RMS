...
export default function SadminProductsScreen() {
					...
					<View style={styles.productList}>
						{filteredProducts.map((prod) => (
							<ProductCard 
								key={prod.id} 
								product={prod} 
								onEdit={permissions.includes('edit_products') ? handleEditProduct : null}
								onDelete={permissions.includes('delete_products') ? handleDeleteProduct : null}
							/>
						))}
					</View>
				)}
