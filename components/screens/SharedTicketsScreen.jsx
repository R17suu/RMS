...
import { fetchMyTickets, fetchTickets, createTicket, updateTicketStatus, deleteTicketRecord } from '../../services/ticketService';
...
export default function SharedTicketsScreen({ headerComponent, role = 'admin' }) {
        ...
        const loadTickets = async () => {
            try {
                if (auth.currentUser?.uid) {
                    ...
                    const fetchedTickets = role === 'sadmin' 
                        ? await fetchTickets()
                        : await fetchMyTickets(auth.currentUser.uid);
        ...
        <ThemedView style={styles.container} safe>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                {tickets.length === 0 && !isLoading ? (
                    ...
                    <TicketQueue 
                        tickets={tickets} 
                        onStatusChange={role === 'sadmin' ? handleStatusChange : null} 
                        onDelete={role === 'sadmin' ? handleDeleteTicket : null} 
                    />
                )}
            </ScrollView>
        </ThemedView>
